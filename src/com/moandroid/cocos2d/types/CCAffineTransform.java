...
public class CCAffineTransform {
     ...
     * @throws CCNoninvertibleTransformException
...
//            throw new NoninvertibleTransformException("Determinant is zero");
    ...
    public CCPoint inverseTransform(CCPoint src, CCPoint dst)
        ...
        double det = getDeterminant();
        if (Math.abs(det) < ZERO) {
            throw new CCNoninvertibleTransformException("Determinant is zero"); //$NON-NLS-1$
        }
...
//    }
    ...
    public class CCNoninvertibleTransformException extends java.lang.Exception {
         ...
         */
        public CCNoninvertibleTransformException(String s) {
            super(s);
        }
