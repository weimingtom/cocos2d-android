...
public class CCAnimation implements CCAnimationProtocol {
	...
	public static CCAnimation animation(String string, float f) {
		return new CCAnimation(string,f);
	}
	   private String _name;
	    ...
	    public CCAnimation(String n, float d) {
	        this(n, d, new CCTexture2D[]{});
	    }

	    public CCAnimation(String n, float d, String... filenames) {
	        _name = n;
